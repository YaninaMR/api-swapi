...
function addNews(response) {
  $.each(response, function(index) {
    ...
    img.setAttribute('class', 'small modal-trigger'); 
    img.setAttribute('id', '#modal1');
    // img.setAttribute('class', 'modal-trigger');       
  });
  ...
  $('.warsClass').each(function(i, itemdiv) {
    ...
    /* let contenedor =$('#content-modal0');
      let contModal = `<div id="modal1" class="modal">
